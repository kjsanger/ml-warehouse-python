...
from sqlalchemy.dialects.mysql import BIGINT as mysqlBIGINT, CHAR as mysqlCHAR, DATETIME as mysqlDATETIME, DOUBLE as mysqlDOUBLE, ENUM as mysqlENUM, FLOAT as mysqlFLOAT, INTEGER as mysqlINTEGER, MEDIUMTEXT as mysqlMEDIUMTEXT, SMALLINT as mysqlSMALLINT, TINYINT as mysqlTINYINT, VARCHAR as mysqlVARCHAR
...
t_cherrypicked_samples = Table(
    'cherrypicked_samples', metadata,
    Column('root_sample_id', mysqlMEDIUMTEXT),
...
class SeqProductIrodsLocations(Base):
    ...
    id_product = Column(String(64), nullable=False, index=True, comment='A sequencing platform specific product id. For Illumina, data corresponds to the id_iseq_product column in the iseq_product_metrics table')
